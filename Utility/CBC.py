...
def CBC_Encrypt(plain, initvektor): #Diese Funktion erwartet einen Plaintext, der Bereits mit Utf-8 Utility vorbereitet wurde und ein Initialisierungsvektor, der dual und 8 Stellen lang ist.
	if len(initvektor) != 8:
		exit()
	Block = list()
