...
def DeMixColumns(eingabeBlock = []): #Multipliziere und Verknuepfe XOr mit einer gegebenen Matrix auf Basis des Galouiskoerpers; Rueckgabeformat: Array mit Werten: 0x..
...
op = []
op.append(['04','e0','48','28'])
op.append(['66','cb','f8','06'])
op.append(['81','19','d3','26'])
op.append(['e5','9a','7a','4c'])

print(DeMixColumns(op))